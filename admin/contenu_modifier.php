            ...
            <div class="row-fluid">
                <div class="span4">
                    <ul class="nav nav-pills">
                        <?php foreach (LangAdmin::getInstance()->getList() as $displayLang): ?>
                            <li class="<?php if ($displayLang->id == $lang) { ?>active<?php } ?>"><a href="contenu_modifier.php?id=<?php echo $contenu->id; ?>&dossier=<?php echo $contenu->dossier ?>&lang=<?php echo $displayLang->id; ?>" class="change-page change-lang"><img src="gfx/lang<?php echo $displayLang->id; ?>.gif" /></a></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                <div class="span4 offset4" style="text-align: right">
                    <ul class="nav nav-pills">
                        <li class="">
                            <?php
                            $previous = ToolBoxAdmin::getPrevious($contenu, 'dossier');
                            if($previous !== false)
                            {
                            ?>
                        ...
                        <li class="">
                            <a href="<?php echo urlfond("contenu", "id_contenu=$contenu->id&id_dossier=$contenu->dossier", true); ?>" target="_blank" title="<?php echo trad('preview', 'admin'); ?>" class="change-page">
                    ...
                    <div class="tab-pane <?php if ($tab == 'imageTab') echo "active"; ?>" id="imageTab">
                        ...
                        <div class="row-fluid js-bloc-image" js-image-id="<?php echo $image['id'] ?>">
                            <div class="span3" style="position: relative;">
                                ...
                                $image["nomFichier"] ?>&type=contenu&width=250&height=250&exact=1">
